package com.zhangpei.testcaffeine.service;
...
public class TestService {
    ...
    @Cacheable(value = "container1", key = "'test2'+#str")
    public String test(String str) {
        System.out.println("TestService test:" + str);
        return str;
    }

    @Cacheable(cacheManager = "caffeineCacheManager2", value = "container2", key = "'test2'+#str")
